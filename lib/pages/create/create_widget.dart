                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if ((_model.textController1.text != null &&
                        ...
                        _model.apiResultxc2 =
                            await DummyAPIGroup.createPostCall.call(
                          text: _model.textController1.text,
                          image: _model.textController3.text,
                          likes: int.tryParse(_model.textController2.text),
                        );
                        if ((_model.apiResultxc2?.succeeded ?? true)) {
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text('There is an error in server.'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              title: Text('Check form.'),
                              content: Text('Please fill the form correct.'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
                                      Navigator.pop(alertDialogContext),
